...
void initNeuroblastoma(flamegpu::HostAPI &FLAMEGPU) {
    ...
    for (int j = 0; j < static_cast<int>(clones.size()); ++j) {
        ...
        for (unsigned int i = 0; i < NB_COUNT; ++i) {
            ...
            // Initial conditions.
            // telo_count is the total number of telomere units(categorical, integers from 0 to 60).
            //     The maximum is 60 (Hayflick et al., 1961).
            //     1 means random initialisation between 41 and 60, inclusive.
            //     2 means random initialisation between 1 and 20, inclusive.
            //     3 means random initialisation between 21 and 40, inclusive.
            ...
            agt.setVariable<int>("ALT", agt.getVariable<int>("ALT") == 0 && agt.getVariable<int>("ATRX_inact") == 1 ? 1 : agt.getVariable<int>("ALT"));
