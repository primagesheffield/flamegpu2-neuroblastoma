...
flamegpu::AgentDescription &defineSchwann(flamegpu::ModelDescription& model) {
    ...
    // Agent functions
    {
        sc.newRTCFunctionFile("output_matrix_grid_cell", "src/rtc/output_matrix_grid_cell.cu");
        auto &t = sc.newRTCFunctionFile("sc_cell_lifecycle", "src/rtc/sc_cell_lifecycle.cu");
