...
void data_layer_0(flamegpu::ModelDescription& model) {
    ...
    std::array<float, 6 * 336> chemo_effects = {0.602666f, 0.602666f, 0.602666f, 0.602666f, 0.602666f, 0.602666f};
    env.newProperty<float, 6 * 336>("chemo_effects", chemo_effects);
